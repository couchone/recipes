...
* Stretch-Goal: To make the content available via CouchDB pull replication into a Markdown-HTML converter CouchApp
                so the docs are available in offline mode as well. (tool building will be needed here)
